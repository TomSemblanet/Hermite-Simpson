...
class MT_UDP:
	...
	def get_nec(self):	
	  ...
	  return self.problem_tr.constraints.path_e_indx * self.problem_tr.problem.prm['n_nodes'] + \
	   		self.problem_tr.constraints.event_e_indx

	def get_nic(self):
		""" Returns the number of inequality constraints """
		return 2 * (self.problem_tr.constraints.path_i_indx * self.problem_tr.problem.prm['n_nodes'] + \
			self.problem_tr.constraints.event_i_indx)
